...
public class facebook {
    ...
    public void test1() throws InterruptedException {
        ...
        //Sending FirstName
        fb.findElement(By.xpath("//input[@class='inputtext _58mg _5dba _2ph-']")).sendKeys("Lokkk");
        Thread.sleep(2000);
        //Sending LastName
        fb.findElement(By.name("lastname")).sendKeys("Dharang");
        //Sending Email
        fb.findElement(By.name("reg_email__")).sendKeys("testuser@grktest.com");
        //Re-entering Email
        fb.findElement(By.name("reg_email_confirmation__")).sendKeys("testuser@grktest.com");
        //Sending password
